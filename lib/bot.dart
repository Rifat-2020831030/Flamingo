import 'dart:convert';
import 'dart:io';
import 'package:data_vis/bot_api.dart';
...
class _ChatPageState extends State<ChatPage> {
          ...
          child: Column(
            ...
            children: <Widget>[
              TextButton(
                ...
                child: const Row(
                  children: [
                    Icon(Icons.attachment), // Add an image icon here
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: Center(child: const Text("FiBot: AI Fire Expert")),
          backgroundColor: Color.fromARGB(52, 64, 65, 65),
        ),
        backgroundColor: Color.fromARGB(255, 179, 179, 179),
        body: Chat(
          isAttachmentUploading: isDataLoading,
          l10n: const ChatL10nEn(
            emptyChatPlaceholder: 'Hey There, \n How I can help you?',
          ),
          messages: _messages,
